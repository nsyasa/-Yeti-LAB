/**
 * AdminModals - Admin panel modal bileşenleri
 * Tüm modal'ları tek bir yerden yönetir
 */
const AdminModals = {
    /**
     * Tüm modal'ları render et
     */
    renderAll() {
        return `
    ...
    showConfirm(title, message, onConfirm) {
        ...
        if (confirmBtn) {
            confirmBtn.onclick = () => {
                this.hide('confirm-delete-modal');
                if (onConfirm) onConfirm();
            };
        }

        this.show('confirm-delete-modal');
    },
};
