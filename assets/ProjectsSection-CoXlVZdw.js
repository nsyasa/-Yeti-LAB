const s={render(){return`
        ...
        `},renderSimulationSection(){return`
        ...
        `},initializeRichTextEditors(){if(typeof window.AdminRichTextEditor>"u"){console.warn("[ProjectsSection] AdminRichTextEditor modülü bulunamadı, textarea kullanılacak");return}const e={mission:{tr:null,en:null},theory:{tr:null,en:null},challenge:{tr:null,en:null},codeExplanation:{tr:null,en:null}},t=document.getElementById("p-mission-tr-editor"),r=document.getElementById("p-mission-en-editor");t&&(e.mission.tr=window.AdminRichTextEditor.create(t,{placeholder:"Türkçe amaç açıklaması (Markdown destekli)...",autosave:!1})),r&&(e.mission.en=window.AdminRichTextEditor.create(r,{placeholder:"English mission description (Markdown supported)...",autosave:!1}));const a=document.getElementById("p-theory-tr-editor"),o=document.getElementById("p-theory-en-editor");a&&(e.theory.tr=window.AdminRichTextEditor.create(a,{placeholder:"Türkçe teorik bilgi (Markdown destekli)...",autosave:!1})),o&&(e.theory.en=window.AdminRichTextEditor.create(o,{placeholder:"English theory (Markdown supported)...",autosave:!1}));const d=document.getElementById("p-challenge-tr-editor"),i=document.getElementById("p-challenge-en-editor");d&&(e.challenge.tr=window.AdminRichTextEditor.create(d,{placeholder:"Türkçe meydan okuma (Markdown destekli)...",autosave:!1})),i&&(e.challenge.en=window.AdminRichTextEditor.create(i,{placeholder:"English challenge (Markdown supported)...",autosave:!1}));const n=document.getElementById("p-codeExplanation-tr-editor"),l=document.getElementById("p-codeExplanation-en-editor");n&&(e.codeExplanation.tr=window.AdminRichTextEditor.create(n,{placeholder:"Türkçe kod açıklaması (Markdown destekli)...",autosave:!1})),l&&(e.codeExplanation.en=window.AdminRichTextEditor.create(l,{placeholder:"English code explanation (Markdown supported)...",autosave:!1})),window.projectEditors=e,console.log("[ProjectsSection] Rich Text Editors initialized:",e),window.CourseSettings&&window.CourseSettings.applyCustomTabNames&&window.CourseSettings.applyCustomTabNames()},destroyRichTextEditors(){window.projectEditors&&(Object.values(window.projectEditors).forEach(e=>{e.tr?.destroy&&e.tr.destroy(),e.en?.destroy&&e.en.destroy()}),window.projectEditors=null)}};window.ProjectsSection=s;
