const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-ByngonH0.js","./router-DvtGKn0B.js","./router-nk19jXMv.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-D9KGgVqh.js";import"./router-DvtGKn0B.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
