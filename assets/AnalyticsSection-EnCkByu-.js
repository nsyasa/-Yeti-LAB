const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-UaddntKD.js","./router-BFmYSC8h.js","./router-Dd0B837Q.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-DSunrIcW.js";import"./router-BFmYSC8h.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
