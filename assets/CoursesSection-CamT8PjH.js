const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-hTjch34r.js","./router-DsTj0m_O.js","./router-DFNhUn_5.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-DllimcBI.js";import"./router-DsTj0m_O.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
