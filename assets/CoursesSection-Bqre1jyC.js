const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-CExCk4Ru.js","./router-DnUGz--H.js","./router-6lsuVzmK.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-DFfyIJhU.js";import"./router-DnUGz--H.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
