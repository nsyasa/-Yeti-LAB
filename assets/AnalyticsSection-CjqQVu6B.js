const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-BmS6C7fN.js","./router-DsTj0m_O.js","./router-DFNhUn_5.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-DllimcBI.js";import"./router-DsTj0m_O.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
