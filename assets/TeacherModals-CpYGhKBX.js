const r={renderAll(){return`
        ...
        `},renderAvatarButtons(){return["🎓","👦","👧","🧑","👨‍🎓","👩‍🎓","🤖","🦸"].map((e,a)=>`
            <button type="button" onclick="TeacherManager.selectAvatar('${e}')"
                class="avatar-btn text-2xl p-2 rounded-lg border-2 ${a===0?"border-theme bg-theme/10 selected":"border-gray-200"} hover:border-theme transition-colors"
                data-emoji="${e}">
                ${e}
            </button>
        `).join("")},bulkAddModal(){return`
        ...
        `},renderEditAvatarButtons(){return["🎓","👦","👧","🧑","👨‍🎓","👩‍🎓","🤖","🦸"].map(e=>`
            <button type="button" onclick="TeacherManager.selectEditAvatar('${e}')"
                class="edit-avatar-btn text-2xl p-2 rounded-lg border-2 border-gray-200 hover:border-theme transition-colors"
                data-emoji="${e}">
                ${e}
            </button>
        `).join("")},studentDetailModal(){return`
