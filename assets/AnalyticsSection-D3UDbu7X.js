const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-8-iUW6ZV.js","./router-__dgyCIu.js","./router-Bbkw7dIS.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-89UgIToh.js";import"./router-__dgyCIu.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
