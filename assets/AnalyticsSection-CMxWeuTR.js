const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-DEPbrXOn.js","./router-DnUGz--H.js","./router-6lsuVzmK.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-DFfyIJhU.js";import"./router-DnUGz--H.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
