const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-DjD8RC3o.js","./router-IanoY4pe.js","./router-nk19jXMv.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-DYUEt0RH.js";import"./router-IanoY4pe.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
