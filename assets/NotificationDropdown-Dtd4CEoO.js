const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./notificationService-CFAxx3r9.js","./router-__dgyCIu.js","./router-Bbkw7dIS.css"])))=>i.map(i=>d[i]);
import{_ as r}from"./main-89UgIToh.js";import"./router-__dgyCIu.js";const d={isOpen:!1,notifications:[],unreadCount:0,isLoading:!1,_unsubscribe:null,async init(){const{default:t}=await r(async()=>{const{default:e}=await import("./notificationService-CFAxx3r9.js");return{default:e}},__vite__mapDeps([0,1,2]),import.meta.url);this.unreadCount=await t.getUnreadCount(),this.updateBadge(),this._unsubscribe=t.subscribe(({unreadCount:e,newNotification:i})=>{this.unreadCount=e,this.updateBadge(),i&&this.isOpen&&this.loadNotifications(),i&&window.showToast&&window.showToast(i.title,"info")}),console.log("[NotificationDropdown] Initialized")},destroy(){this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=null)},renderBellIcon(){return`
