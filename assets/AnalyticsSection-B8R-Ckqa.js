const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-CVkD2wlp.js","./router-DvtGKn0B.js","./router-nk19jXMv.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-D9KGgVqh.js";import"./router-DvtGKn0B.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
