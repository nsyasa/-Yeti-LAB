const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-Dc9YZZJd.js","./router-BpwVUcYk.js","./router-CTlW14eM.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-CE0Uuwkv.js";import"./router-BpwVUcYk.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
