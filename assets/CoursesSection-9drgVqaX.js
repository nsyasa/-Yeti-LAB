const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-BJCbigwe.js","./router-CF1iH7HH.js","./router-CTlW14eM.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-uTPioC_n.js";import"./router-CF1iH7HH.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
