const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-BxOyFng8.js","./router-__dgyCIu.js","./router-Bbkw7dIS.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-89UgIToh.js";import"./router-__dgyCIu.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
