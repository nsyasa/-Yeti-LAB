const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-CB3PYceP.js","./router-DkhU4yIh.js","./router-P-fjebgT.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-QWdJgBHC.js";import"./router-DkhU4yIh.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
