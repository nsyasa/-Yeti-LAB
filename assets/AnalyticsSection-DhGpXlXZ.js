const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-BpjqLlNN.js","./router-Or4wfhGM.js","./router-CAJGrAsN.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-DgZp9sVb.js";import"./router-Or4wfhGM.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
