const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-Cg9E4RKd.js","./router-C55G4ZtK.js","./router-C7Q8m1qn.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-BZLhLrcT.js";import"./router-C55G4ZtK.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
