const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-BnlIu386.js","./router-BpwVUcYk.js","./router-CTlW14eM.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-CE0Uuwkv.js";import"./router-BpwVUcYk.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
