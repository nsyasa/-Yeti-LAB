const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-DZVX51D5.js","./router-IanoY4pe.js","./router-nk19jXMv.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-DYUEt0RH.js";import"./router-IanoY4pe.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
