const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-DRC3AkDs.js","./router-Or4wfhGM.js","./router-CAJGrAsN.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-DgZp9sVb.js";import"./router-Or4wfhGM.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
