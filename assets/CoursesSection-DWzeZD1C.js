const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-C3PkxhDO.js","./router-C55G4ZtK.js","./router-C7Q8m1qn.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-BZLhLrcT.js";import"./router-C55G4ZtK.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
