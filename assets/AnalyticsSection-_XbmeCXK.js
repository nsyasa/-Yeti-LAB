const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-DX0naOGG.js","./router-DuwzWHTb.js","./router-DZTB83x5.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-A_Rv7bmM.js";import"./router-DuwzWHTb.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
