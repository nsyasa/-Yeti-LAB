const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./analyticsService-BgzeV7QW.js","./router-CF1iH7HH.js","./router-CTlW14eM.css"])))=>i.map(i=>d[i]);
import{_ as o}from"./main-uTPioC_n.js";import"./router-CF1iH7HH.js";const c={summary:null,submissionTrend:[],classroomPerformance:[],assignmentStats:[],topStudents:[],statusDistribution:null,recentActivity:[],isLoading:!1,render(){return`
