const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./courseEnrollmentService-R-XugPK5.js","./router-DuwzWHTb.js","./router-DZTB83x5.css"])))=>i.map(i=>d[i]);
import{_ as n}from"./main-A_Rv7bmM.js";import"./router-DuwzWHTb.js";const d={courses:[],classrooms:[],enrollmentStats:{},selectedCourse:null,selectedCourseIndex:0,isLoading:!1,render(){return`
